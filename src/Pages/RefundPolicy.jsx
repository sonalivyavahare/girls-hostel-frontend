...
const RefundPolicy = () => {
    ...
    const getPolicy = async () => {
        const response = await getHostelPolicyByType("Refund Policy")
    ...
    return (
        ...
        <Box sx={{ marginTop: "40px", marginBottom: "40px" }}>
            <Box display="flex" alignItems="center" justifyContent="center" sx={{ padding: 2 }}>
                ...
                <Typography variant="h3" fontSize="32px" fontWeight="bold" color={menuBarColor} textTransform="uppercase"> Refund Policy</Typography>
